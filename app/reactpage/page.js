...
export default function Home() {
  ...
  const imageUrls = [
    {url: '/ReactImage.png', link:'https://react.dev/'},
  ...
  const imageSizes = {
    '/ReactImage.png': { width: 350, height: 150 },
  ...
  const fetchUrls = async () => {
    const res = await fetch('/api/urlreact');
  ...
  return (
    <div style={styles.container}>
      ...
      <h2 style={styles.title}>LWJ&apos;s <span style={{fontSize:'1.3rem', color:'grey'}}>React</span> Media Repository</h2>
